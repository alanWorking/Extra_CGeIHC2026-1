...
int main()
{
	...
	Model Toroide1("resources/objects/Nombre/GrafitiNombre.obj");
	Model Toroide2("resources/objects/Nombre/Grafiti2.obj");//casaVieja
	Model Toroide3("resources/objects/Nombre/Grafiti3.obj");//casaDoll
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::scale(model, glm::vec3(100.0f, 100.0f, 100.0f));
		staticShader.setMat4("model", model);
		//base1.Draw(staticShader);

		model = glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(0.0f, 500.0f + movTor1_y, movTor1_z));
		model = glm::rotate(model, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 500.0f + movTor2_y, 0.0f + movTor2_z));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		staticShader.setMat4("model", model);
		staticShader.setVec3("dirLight.specular", glm::vec3(0.9f, 0.0f, 0.0f));
		Toroide2.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 500.0f + movTor3_y, 0.0f + movTor3_z));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		staticShader.setMat4("model", model);
		staticShader.setVec3("dirLight.specular", glm::vec3(0.9f, 0.0f, 0.0f));
